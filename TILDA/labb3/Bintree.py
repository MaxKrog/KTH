class Bintree(): #Binary Search Tree "Controller".
	...
	def _write(self,node,indentation): #Indentation increases recursively for better visualisation.
...
class Node():
	...
	def hasRightChild(self): 
		return bool(self.right) #Python 'translates' None to False and Object to True.
